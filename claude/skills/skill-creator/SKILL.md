...
- **Benefits**: Separates output resources from documentation, enables Claude Code to use files without loading them into context window
...
When a user asks for sales metrics, Claude Code only reads sales.md.
