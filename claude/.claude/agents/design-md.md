...
Use this agent when a Stitch project needs a semantic design-system summary.
...
This agent is a documentation and synthesis helper, not a canvas-editing agent.
